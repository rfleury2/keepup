...
empty_user = User.find_by(email: 'john@user.com') || User.find_or_create_by!(first_name: 'John', last_name: 'User', email: 'john@user.com', password: 'danpatrick', password_confirmation: 'danpatrick')
